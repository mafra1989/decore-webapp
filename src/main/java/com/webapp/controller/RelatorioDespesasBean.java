...
public class RelatorioDespesasBean implements Serializable {
    ...
    private void createPieModel() {
        ...
        List<Object[]> despesasTemp = despesas.totalDespesasPorCategoriaMesAtual();
    ...
    public void createBarModel() {
        ...
        Number totalDebitos = despesas.totalDebitos();
        Number totalCreditos = despesas.totalCreditos();
