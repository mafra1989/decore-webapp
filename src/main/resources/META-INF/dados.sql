...
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (176,'Água',43,38);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (177,'Luz',43,38);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (37565,'Aporte',47,42);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (180,'Aluguel',43,38);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (183,'Manutenção de Veículos',43,39);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (186,'Manutenção de Equipamentos',43,39);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (185,'Despesas com alimentação e mantimentos',43,39);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (190,'Aquisição de bens e equipamentos',43,40);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25832,'Avarias',43,39);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25833,'Combustível',43,39);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25834,'Custos e viagens a negócios',43,39);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25836,'Despesas com saúde',43,39);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25837,'Empréstimos',43,41);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25838,'Frete de veículos',43,39);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25839,'Impostos',43,39);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25840,'Limpeza e serviços gerais',43,39);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25841,'Mão de obra com entregas',43,39);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25842,'Mão de obra em aduelas e alisares',43,40);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25843,'Material e serviço de construção',43,39);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25844,'Material indireto',43,39);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25845,'Material para acabamento em aduelas e alisares',43,40);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25846,'Material para serviços em MDF',43,40);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25847,'Material para acabamento em portas',43,40);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25848,'Material para serviços em vidro',43,40);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25849,'Material para uso direto',43,39);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25850,'Outras receitas',43,42);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25851,'Propaganda e marketing',43,39);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25853,'Segurança',43,39);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25854,'Serviço de manutenção em geral',43,39);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (178,'Telefone, internet e informática',43,38);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25855,'Transporte',43,38);
INSERT INTO categorias_lancamentos(id,nome,destinolancamento_id,tipolancamento_id) VALUES (25835,'Salários  / Décimo / Férias / Bônus / PLR',43,40);
